...
const AboutFront = () => {
  ...
  return (
    <div className="about-front-container">
      ...
      <div className="about-front-flex-container">
        ...
        <div className="about-front">
          ...
          <p className="small-paragraph" style={{ fontSize: "85%" }}>
          ...
          <p className="small-paragraph" style={{ fontSize: "85%" }}>
            ...
            interested in adopting a puppy you are welcome to come visit them to
            see which one you want. You can reach out to us to get our address.
          </p>
        </div>
      </div>
    </div>
